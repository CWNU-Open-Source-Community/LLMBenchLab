import { FlaskConical, Gauge, Layers3, Play, Trophy } from "lucide-react";
...
function App() {
  ...
  const pageName = location.pathname.startsWith("/runs/") && location.pathname !== "/runs/new"
    ? "Run 详情"
    : pageNames[location.pathname] || "LLMBenchLab";
