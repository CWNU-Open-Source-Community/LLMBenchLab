...
function runFixture(status: RunStatus, overrides: Partial<EvaluationRun> = {}): EvaluationRun {
  return {
    ...
    lease_owner: status === "running" ? "worker-001" : null,
    lease_token: 1,
    lease_expires_at: status === "running" ? "2026-08-27T08:01:00Z" : null,
    heartbeat_at: status === "running" ? "2026-08-27T08:00:30Z" : null,
